...
BNcopy =:  ' BN_copy > + x x x' ssl NB.BIGNUM *BN_copy(BIGNUM *to, const BIGNUM *from);
BNswap =:  ' BN_swap > + x x x' ssl
BNadd =:  ' BN_add > + i x x x' ssl   NB.int BN_add(BIGNUM *r, const BIGNUM *a, const BIGNUM *b)
BNadd_word =: ' BN_add_word > + i x i' ssl NB. int BN_add_word(BIGNUM *a, BN_ULONG w)
BNmod_sqr =: ' BN_mod_sqr > + i x x x x' ssl NB.BN_mod_sqr(BIGNUM *r, BIGNUM *a, const BIGNUM *m, BN_CTX *ctx);
BNmod_exp =: ' BN_mod_exp > + i x x x x x' ssl NB.int BN_mod_exp(BIGNUM *r, BIGNUM *a, const BIGNUM *p,const BIGNUM *m, BN_CTX *ctx);
BNmod_mul =: ' BN_mod_mul > + i x x x x x' ssl
BNmod_add =: ' BN_mod_add > + i x x x x x' ssl
BNmod_sub =: ' BN_mod_sub > + i x x x x x' ssl
BNmod_inv=: ' BN_mod_inverse > + x x x x x' ssl  NB.BIGNUM *BN_mod_inverse(BIGNUM *r, BIGNUM *a, const BIGNUM *n, BN_CTX *ctx);
BNmod_word =: ' BN_mod_word > + i x i' ssl NB.BN_ULONG BN_mod_word(const BIGNUM *a, BN_ULONG w);
BNdiv_word =: ' BN_div_word > + i x i' ssl NB.BN_ULONG BN_div_word(BIGNUM *a, BN_ULONG w);
BNmul_word=: ' BN_mul_word > + i x i' ssl NB.int BN_mul_word(BIGNUM *a, BN_ULONG w);
BNsub_word=: ' BN_sub_word > + i x i' ssl NB.int BN_sub_word(BIGNUM *a, BN_ULONG w);
BNset_word=: ' BN_set_word > + i x i' ssl NB.int BN_set_word(BIGNUM *a, unsigned long w); unsigned long BN_get_word(BIGNUM *a);
BNget_word=: ' BN_get_word > + l x' ssl
BNis_word=: ' BN_is_word > + i x x' ssl
NB. BNis_odd=: ' BN_is_odd > + i x ' ssl
BNcmp=: ' BN_cmp > + i x x' ssl
BNmul =:  ' BN_mul > + i x x x x' ssl  
BNexp =:  ' BN_exp > + i x x x x' ssl 
BNsub =:  ' BN_sub > + i x x x' ssl 
